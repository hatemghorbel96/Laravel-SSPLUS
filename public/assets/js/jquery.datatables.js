...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "pas d'entrées pour afficher"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *    } );
			 */
			"sLengthMenu": "Spectacle _MENU_ les entrées",
	...
	$.extend( extPagination, {
		simple: function ( page, pages ) {
			return [ 'précédente', 'suivante' ];
		},

		full: function ( page, pages ) {
			return [  'première', 'précédente', 'suivante', 'dernière' ];
		},
		...
		simple_numbers: function ( page, pages ) {
			return [ 'précédente', _numbers(
				page, pages), 'suivante' ];
		},

		full_numbers: function ( page, pages ) {
			return [ 'première','précédente', _numbers(page, pages), 'suivante', 'dernière' ];
		},
