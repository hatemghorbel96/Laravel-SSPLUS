...
-->
    ...
    <div class="logo">
      <a href="{{ url('/client') }}" class="simple-text">
        SSPLUS
      </a>
    </div>
    ...
    <div class="sidebar-wrapper">
      ...
      <li >
        ...
        <li>
          <a href="{{url('/client/calendar') }}">
            <i class="fa fa-calendar"></i>
            <p>Calendrier</p>
          </a>
        </li>
        <li>
          <a href="{{url('/client/intervention') }}">
            <i class="glyphicon glyphicon-pushpin"></i>
            <p>Interventions</p>
          </a>
        </li>
        <li>
          <a href="{{url('/client/fileintervention') }}">
            <i class="glyphicon glyphicon-folder-open"></i>
            <p>Fichiers des interventions</p>
          </a>
        </li>
        <li>
          <a href="{{url('/client/contrat') }}">
            <i class="fa fa-handshake-o"></i>
            <p>Contrat</p>
          </a>
        </li>
        <li>
          <a href="{{url('/client/reclamation') }}">
