                    ...
                    <div class="profile-header row">
                        ...
                        <div class="col-md-12 col-sm-12 profile-info">
                            <div class="row">
                                ...
                                <div class="col-md-14">
                                    <div class="header-fullname">{{$client->prenom}} {{$client->nom}} </div>
                                </div>
...
<center>
                            <div class="row">
                                   ...
                                   <tr><td><label class="stats-value pink">Email</label></td>
                                       <td>  <label class="stats-title">{{$client->email}}</label></td>
                                   </tr>

    <br>
    <tr><td> <label class="stats-value pink">Login</label></td>
        <td>   <label class="stats-title">{{$client->Login}}</label></td> </tr>
        <tr><td> <label class="stats-value pink">Pass</label></td>
        <td>   <label class="stats-title">{{$client->Pass}}</label></td> </tr>
        <tr><td> <label class="stats-value pink">Identifion</label></td>
        <td>   <label class="stats-title">{{$client->Identifion}}</label></td> </tr>
        <tr><td> <label class="stats-value pink">Nom de la Societe</label></td>
        <td>   <label class="stats-title">{{$client->Societe}}</label></td> </tr>
                                </div>
</center>
                            </div>
                        <br>
                            ...
                            <div class="row">
                                ...
                                <center>
                               <tr><td><label class="stats-value pink">Telephone</label></td>
                               <td><label class="stats-title">{{$client->Telephone}}</label></td> </tr>
                                </center>
                            </div>
                        <br>
                        <br>
