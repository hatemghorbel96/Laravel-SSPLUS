                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <a href="#" class="btn btn-palegreen btn-sm pull-right btn-follow">
                                        <i class="fa fa-check"></i> {{$employer->Fonction}}
                                    </a>
                                </div>
                                <div class="col-md-14">
                                    <div class="header-fullname">{{$employer->Prenom}} {{$employer->Nom}} </div>
                                </div>
...
<center>
                            <div class="row">
                                   ...
                                   <tr><td><label class="stats-value pink">Email</label></td>
                                       <td>  <label class="stats-title">{{$employer->Email}}</label></td>
                                   </tr>

    <br>
    <tr><td> <label class="stats-value pink">Télephone</label></td>
        <td>   <label class="stats-title">{{$employer->Telephone}}</label></td> </tr>
                        ...
                        <br>
                            ...
                            <div class="row">
                                ...
                                <center>
                               <tr><td><label class="stats-value pink">Date Naissance</label></td>
                               <td><label class="stats-title">{{$employer->dateNais}}</label></td> </tr>
                                </center>
                            </div>
                        <br>
                        <br>
