...
@section('content')
    ...
    @endif
        <div class="container-fluid">
            <div class="card">
                <form id="main" action="{{route('emp.store')}}" method="post">
                    @csrf
                    ...
                    <div class="card-content">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input class="form-control" name="Telephone" type="tel" required="true" />
                            </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control datepicker" name="dateNais"  />
                            </div>
                        </div>
